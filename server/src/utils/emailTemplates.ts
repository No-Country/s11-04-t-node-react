export const generateSendOTPTemplate = (code: string): string => {
  return `
  <!doctype html>
  <html lang="es">
  <head>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h1>Usa este código para iniciar sesión en Barber Buddy</h1>
                        <h2>Solo te falta un paso más para usar la aplicación. Ingrese el siguiente código de verificación, tendrá 10 minutos para hacerlo, de lo contrario, tendrá que solicitar otro.</h2>
