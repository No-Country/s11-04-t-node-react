...
export const Notification = ({ notification }) => {
	...
	const errorStyle =
		'h-10 px-2 border border-red-600 bg-red-100 rounded-2xl flex items-center gap-10 text-red-700 text-xl my-4'
	const successStyle =
		'h-10 px-2 border border-green-600 bg-lime-50 rounded-2xl flex items-center gap-10 text-green-800 text-xl my-4'
