...
function ClientModify({
  ...
  return modalModifyClient ? (
    <div
      ...
      className="bg-[#292D33] text-white border rounded-lg p-5 absolute top-[12vh] sm:top-1/2 h-[75vh] sm:h-fit overflow-hidden left-1/2 -translate-x-1/2 sm:-translate-x-1/4 sm:-translate-y-1/2"
    >
