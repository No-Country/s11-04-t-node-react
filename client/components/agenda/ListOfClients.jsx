...
const ListOfClients = () => {
    ...
    useEffect(() => {
        ...
        getClients()
        setHiddenListOfClients(true)
    }, [])


    return (
        <div className={`${hiddenListOfClients ? 'block' : 'hidden'} fixed w-full h-screen flex items-center justify-center top-0 left-0 z-40 overflow-x-hidden overflow-y-auto md:inset-0 bg-black/70`}>
            <div className='relative w-1/2 bg-slate-200 text-black rounded-lg p-10'>
